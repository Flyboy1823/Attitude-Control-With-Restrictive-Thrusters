function [thruster_state, total_impulse_accumulated_per_thruster, current_impulse_added_body]=Attitude_Scheduler(thruster_state,desired_thruster_config, total_impulse_accumulated_per_thruster, F, dt, force_dir, t_min_on, t_max_on, t_min_off, thruster_on_time, thruster_off_time, current_impulse_added_body)
   for i=1:5
